  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.rizkwya.me${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.rizkwya.me${router.asPath}`}
        />
        ...
        <meta name="twitter:site" content="rizk" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">rizk</span>
        </Link>
